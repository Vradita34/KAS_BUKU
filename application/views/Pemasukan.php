            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="card-body">
                            <?php echo form_close(); ?>
                            <form action="<?= base_url('PdfController/pemasukan'); ?>" target="_blank"  method="post">
                ...
                <tbody>
                    ...
                    foreach ($pemasukan as $trx): ?>
                        <tr>
                            ...
                            <td>
                                <?php if ($trx['username'] == $current_user_username || $current_user_level == 'Admin'): ?>
                                    <a onclick="return confirm('Apakah Anda yakin ingin menghapus data ini?')"
                                        href="<?= base_url('pemasukan/hapus/' . $trx['id_transaksi']); ?>">
